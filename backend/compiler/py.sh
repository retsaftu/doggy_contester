...
mkdir ./../uploads/${contestId}/${taskId}/${userId}/py/difference
...
for i in $(seq 1 $testsAmount); do
    ...
    do
        ...
        diff ./../uploads/${contestId}/${taskId}/${userId}/py/output/test${i}.out \
            ...
            &> ./../uploads/${contestId}/${taskId}/${userId}/py/difference/test${i}.out -u

        # Check if user answer is wrong or correct
        if [ -s ./../uploads/${contestId}/${taskId}/${userId}/py/difference/test${i}.out ]; then
            isUserAnswerCorrect=false
        else
